...
//
// import
// com.extensions.logmonitor.jsonLogModule.logFileAnalyzer.dataCache.BPlusDataCache.DataSizeCountable;
// import
// com.extensions.logmonitor.jsonLogModule.logFileAnalyzer.dataCache.BPlusDataCache.SeriAndDeser;
// import
// com.extensions.logmonitor.jsonLogModule.logFileAnalyzer.order.OrderByDataItemWithObj;
...
//
// public ObjBinaryCacheWithBlockSize2(String filePath, SeriAndDeser<T>
// keySeriAndDeser, Class<T> dataClassType) {
...
// new File(this.file, "objBinaryTemp_" + blockIndex.getAndIncrement() +
// ".bina"));
// if (!fileStore.open()) {
...
// }
// this.orderResultStore = new FileStore(new File(file,
// "objBinaryOrderResult.bina"));
...
// FileStore fileStore = new FileStore(
// new File(this.file, "objBinaryTemp_" + this.blockIndex.getAndIncrement() +
// ".bina"));
// if (!fileStore.open()) {
// System.out.println("open file failure!!!!");
// throw new IllegalStateException();
// }
// BlockData<T> blockData = new BlockData<T>(fileStore, this.keySeriAndDeser,
// dataClassType);
...
// blocks.get(i).clear();
// stopwatch.split();
// System.out.println("triggerOver blockIndex:" + i + "\t totalSize:" +
// blocks.get(i).totalSize
...
// System.out.println("blockIndex " + computeBlocks.get(i) + " is empty , remove
// it!!!");
// }
// this.blocks.clear();
...
// }
// stopwatch.split();
// System.out.println("sort over!!! , sort data's size:" + readSize + ",and
// useTime:" + stopwatch.getSplitTime());
...
//
// public BlockData(FileStore fileStore, SeriAndDeser<T> seriAndDes, Class<T>
// dataClassType) {
...
// SeriAndDeser<OrderByDataItemWithObj> keySeriAndDeser = new
// SeriAndDeser<OrderByDataItemWithObj>() {
// @Override
...
// };
//
// ObjBinaryCacheWithBlockSize2<OrderByDataItemWithObj> cache = new
// ObjBinaryCacheWithBlockSize2<>(
