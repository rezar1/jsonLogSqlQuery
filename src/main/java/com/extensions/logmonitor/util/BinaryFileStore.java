 ...
 *
 */
public class BinaryFileStore<T extends DataSizeCountable> {
	 ...
	 */
	public BinaryFileStore(final String file, SeriAndDeser<T> dataSeriAndDeser) {
	 ...
	 *            use DirectByteBuffer or HeapByteBuffer?
	 */
	public BinaryFileStore(final File file, SeriAndDeser<T> dataSeriAndDeser) {
		this.file = file;
